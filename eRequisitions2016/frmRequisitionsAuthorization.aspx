<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.Master" CodeBehind="frmRequisitionsAuthorization.aspx.vb" Inherits="eRequisitions2016.frmRequisitionsAuthorization" %>
    ...
    <table style="width:100%">
        <tr>
            <td colspan="12" style="text-align: right">
                <asp:Label ID="lblTitle" runat="server" Text="HOD Requisitions Authorizations" Font-Bold="True" Font-Size="Medium" ForeColor="#6699FF"></asp:Label></td>
        </tr>
        <tr>
            <td colspan="12">
