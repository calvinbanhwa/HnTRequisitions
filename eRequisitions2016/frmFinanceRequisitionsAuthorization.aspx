<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.Master" CodeBehind="frmFinanceRequisitionsAuthorization.aspx.vb" Inherits="eRequisitions2016.frmFinanceRequisitionsAuthorization" %>
    ...
    <table style="width:100%">
        <tr>
            <td colspan="12" style="text-align: right">
                <asp:Label ID="lblTitle" runat="server" Text="Financial Requisitions Approval" Font-Bold="True" Font-Size="Medium" ForeColor="#6699FF"></asp:Label></td>
        </tr>
        <tr>
            <td colspan="12">
